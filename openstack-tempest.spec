...
%changelog
* Wed June 30 2021 Martin Kopec <mkopec@redhat.com> 1:23:0.0-2
- Introduce inclusive args

* Tue May 12 2020 RDO <dev@lists.rdoproject.org> 1:23.0.0-1
- Update to 23.0.0

* Fri Jul 26 2019 RDO <dev@lists.rdoproject.org> 1:21.0.0-1
- Update to 21.0.0

* Fri Jul 26 2019 Chandan Kumar <chkumar@redhat.com> 1:20.0.0-4
- Removed patches as new tempest tag 21.0.0 is released
