...
* Fri Sep 13 2024 RDO <dev@lists.rdoproject.org> 1:40.0.0-2
- Rebuild in Bobcat

* Wed Sep 11 2024 RDO <dev@lists.rdoproject.org> 1:40.0.0-1
- Update to 40.0.0

* Wed May 29 2024 Alfredo Moralejo <amoralej@redhat.com> 1:39.0.0-3
- Rebuild in Caracal

* Wed May 29 2024 Alfredo Moralejo <amoralej@redhat.com> 1:39.0.0-2
- Rebuild in Bobcat

* Wed May 29 2024 RDO <dev@lists.rdoproject.org> 1:39.0.0-1
- Update to 39.0.0

* Wed Apr 03 2024 RDO <dev@lists.rdoproject.org> 1:38.0.0-4
- Rebuild 38.0.0 in Caracal release

* Wed Apr 03 2024 RDO <dev@lists.rdoproject.org> 1:38.0.0-3
- Rebuild 38.0.0 in Bobcat release

* Wed Apr 03 2024 RDO <dev@lists.rdoproject.org> 1:38.0.0-2
- Rebuild 38.0.0 in Antelope release

* Mon Apr 01 2024 RDO <dev@lists.rdoproject.org> 1:38.0.0-1
- Update to 38.0.0

* Fri Mar 29 2024 RDO <dev@lists.rdoproject.org> 1:37.0.0-3
- Rebuild in Caracal release

* Wed Mar 13 2024 RDO <dev@lists.rdoproject.org> 1:37.0.0-2
- Rebuild in bobcat release

* Mon Mar 11 2024 RDO <dev@lists.rdoproject.org> 1:37.0.0-1
- Update to 37.0.0

* Wed Sep 27 2023 RDO <dev@lists.rdoproject.org> 1:36.0.0-1
- Update to 36.0.0
