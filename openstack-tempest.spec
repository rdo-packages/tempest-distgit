...
Obsoletes:     python3-horizon-tests-tempest < 1.1.0-3
Provides:      python3-horizon-tests-tempest
...
PYTHON=%{__python3} stestr --test-path $OS_TEST_PATH run --concurrency 1
...
* Fri Mar 19 2021 RDO <dev@lists.rdoproject.org> 1:26.1.0-2
- Update to 26.1.0
