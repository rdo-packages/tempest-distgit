...
Patch0001: 0001-Create-router-and-dhcp-when-create_default_network-s.patch
Patch0002: 0001-compute-Move-volume-attached-live-migration-tests-to.patch
BuildArch:      noarch
...
%changelog
* Wed Jun 15 2022 Chandan Kumar <chkumar@redhat.com> 1:31.0.0-2
...
* Wed Apr 13 2022 RDO <dev@lists.rdoproject.org> 1:30.1.0-1
- Update to 30.1.0

* Mon Nov 29 2021 RDO <dev@lists.rdoproject.org> 1:29.1.0-1
- Update to 29.1.0

* Mon Sep 13 2021 RDO <dev@lists.rdoproject.org> 1:28.1.0-1
- Update to 28.1.0

* Mon Mar 29 2021 RDO <dev@lists.rdoproject.org> 1:27.0.0-1
- Update to 27.0.0
